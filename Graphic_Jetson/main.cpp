...
void createLogicalDevice() {
    ...
    // Kiểm tra extension trước khi tạo
    ...
    if (!swapchainSupported) {
        throw std::runtime_error("VK_KHR_swapchain extension not supported!");
    }
    ...
    void createGraphicsPipeline() {
        // Đọc shader từ file SPIR-V (tạo trước)
    ...
    void recordCommandBuffer(VkCommandBuffer commandBuffer, uint32_t imageIndex, float time) {
        ...
        VkClearValue clearColor = {{{std::sin(time) * 0.5f + 0.5f, std::cos(time) * 0.5f + 0.5f, 0.0f, 1.0f}}};
    ...
    void drawFrame() {
        ...
        recordCommandBuffer(commandBuffer, imageIndex, time);
